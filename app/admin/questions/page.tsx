...
export default async function AdminQuestionsPage() {
    ...
    return (
        <div className="container mx-auto flex flex-col items-center p-3 text-center">
            <button className="my-8 flex w-1/3 flex-row space-x-5 rounded-lg border border-blue-500/50 bg-zinc-200 px-10 py-2 font-semibold text-black hover:border-transparent hover:bg-blue-500 hover:text-white dark:hover:text-white">
                <IoCreate
            ...
            <div className="h-3/4 overflow-scroll rounded-2xl border border-slate-500/50 p-2 dark:border-slate-600/50 dark:bg-slate-800">
                <table className="table-auto border-collapse border">
                    <thead className="">
                        <tr>
                            <th className="border border-slate-400/50">ID</th>
                            <th className="border border-slate-400/50">Title</th>
                            <th className="border border-slate-400/50">Body</th>
                            <th className="border border-slate-400/50">Edit</th>
                        </tr>
                    </thead>
                    <tbody>
                        {questionRows}
