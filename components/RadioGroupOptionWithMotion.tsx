...
export function RadioGroupOptionWithMotion({ checkedAnswer, answerText, thisAnswerChoice }: { checkedAnswer: AnswersCorrectAnswerChoiceOptions | undefined, answerText: string | undefined, thisAnswerChoice: AnswersCorrectAnswerChoiceOptions }) {
    return (
